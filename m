...
Received: from smtp4.osuosl.org (smtp4.osuosl.org [140.211.166.137])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F3F54B7DFC
	for <lists.iommu@lfdr.de>; Wed, 16 Feb 2022 03:55:13 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by smtp4.osuosl.org (Postfix) with ESMTP id 47D59415EF;
	Wed, 16 Feb 2022 02:55:12 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp4.osuosl.org ([127.0.0.1])
	by localhost (smtp4.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id DssbZ_lhQAxj; Wed, 16 Feb 2022 02:55:10 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [IPv6:2605:bc80:3010:104::8cd3:938])
	by smtp4.osuosl.org (Postfix) with ESMTPS id 43E804156D;
	Wed, 16 Feb 2022 02:55:10 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 1F2E9C000B;
	Wed, 16 Feb 2022 02:55:10 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@lists.linuxfoundation.org
Received: from smtp4.osuosl.org (smtp4.osuosl.org [140.211.166.137])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 29088C000B
 for <iommu@lists.linux-foundation.org>; Wed, 16 Feb 2022 02:55:09 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp4.osuosl.org (Postfix) with ESMTP id 0035A41582
 for <iommu@lists.linux-foundation.org>; Wed, 16 Feb 2022 02:55:09 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp4.osuosl.org ([127.0.0.1])
 by localhost (smtp4.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id XgEZ5GSiSgDf for <iommu@lists.linux-foundation.org>;
 Wed, 16 Feb 2022 02:55:07 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.8.0
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by smtp4.osuosl.org (Postfix) with ESMTPS id 263CD4156D
 for <iommu@lists.linux-foundation.org>; Wed, 16 Feb 2022 02:55:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644980107; x=1676516107;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=tOiMCzyPNN8VuswjCk2Mg+9YcKmZfGljDGWr1aOZRlo=;
 b=mcLCXEZvXz6bDkW3DMDQi7E0P5fT5vkT01gPOgpAFqv9y50lbdUBKNND
 3nT5cmDIJrHIXheEXEDHhM5c3u9Xv9dmTDwpcUZxiWTbMIxDw0So6gnSn
 IB5R74BZuwSEN+wVlW0bUx16F5iirwlEH53aZz4IZIdMjKYfhz5IjH+d/
 E3N2iWywW10zKGuGVAs7eF964EPihUHDifYM+/Khd0MLz+ZXoCqSkBe//
 3nXfJCVWHeDCanpfmQeeg7pIbsmybJGjsxZ+USGhV1jFqrMayOqxjj+wH
 FgGNDvNabShDlURZ2TtQazedupC+M1koijyh0S1a0hxFfmOcJoon5qiOT A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10259"; a="248106934"
X-IronPort-AV: E=Sophos;i="5.88,371,1635231600"; d="scan'208";a="248106934"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Feb 2022 18:55:07 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.88,371,1635231600"; d="scan'208";a="681312599"
Received: from allen-box.sh.intel.com ([10.239.159.118])
 by fmsmga001.fm.intel.com with ESMTP; 15 Feb 2022 18:55:02 -0800
From: Lu Baolu <baolu.lu@linux.intel.com>
To: Joerg Roedel <joro@8bytes.org>, Jason Gunthorpe <jgg@nvidia.com>,
 Christoph Hellwig <hch@infradead.org>, Ben Skeggs <bskeggs@redhat.com>,
 Kevin Tian <kevin.tian@intel.com>, Ashok Raj <ashok.raj@intel.com>,
 Will Deacon <will@kernel.org>, Robin Murphy <robin.murphy@arm.com>
Subject: [PATCH v4 9/9] iommu: Split struct iommu_ops
Date: Wed, 16 Feb 2022 10:52:49 +0800
Message-Id: <20220216025249.3459465-10-baolu.lu@linux.intel.com>
...
index 1ded6076a75c..9208eca4b0d1 100644
...
index 7e4e82158a80..a1ada7bff44e 100644
--- a/drivers/iommu/amd/iommu.c
+++ b/drivers/iommu/amd/iommu.c
@@ -2274,13 +2274,6 @@ static int amd_iommu_def_domain_type(struct device *dev)
...
index 4c3217b1a870..8fdb84b3642b 100644
--- a/drivers/iommu/ipmmu-vmsa.c
+++ b/drivers/iommu/ipmmu-vmsa.c
@@ -869,14 +869,6 @@ static struct iommu_group *ipmmu_find_group(struct device *dev)
...
index ee80a563c178..50f57624610f 100644
--- a/drivers/iommu/msm_iommu.c
+++ b/drivers/iommu/msm_iommu.c
@@ -668,25 +668,27 @@ irqreturn_t msm_iommu_fault_handler(int irq, void *dev_id)
...
index 204a93a72572..ab57c4b8fade 100644
...
index bbd287d19324..a6700a40a6f8 100644
...
index 43df44f918a1..44c3716e16ee 100644
