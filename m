...
Received: from fraxinus.osuosl.org (smtp4.osuosl.org [140.211.166.137])
	by mail.lfdr.de (Postfix) with ESMTPS id 7BFF619E9F8
	for <lists.iommu@lfdr.de>; Sun,  5 Apr 2020 10:34:16 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by fraxinus.osuosl.org (Postfix) with ESMTP id 35CEE8539A;
	Sun,  5 Apr 2020 08:34:15 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from fraxinus.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id MVZiHd8bj77t; Sun,  5 Apr 2020 08:34:14 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by fraxinus.osuosl.org (Postfix) with ESMTP id 1A449858D3;
	Sun,  5 Apr 2020 08:34:14 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 0F60AC0177;
	Sun,  5 Apr 2020 08:34:14 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@lists.linuxfoundation.org
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 899CDC1D7F
 for <iommu@lists.linux-foundation.org>; Sun,  5 Apr 2020 08:34:12 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by silver.osuosl.org (Postfix) with ESMTP id 7E10E20429
 for <iommu@lists.linux-foundation.org>; Sun,  5 Apr 2020 08:34:12 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id rVvkrPezHAj6 for <iommu@lists.linux-foundation.org>;
 Sun,  5 Apr 2020 08:34:03 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by silver.osuosl.org (Postfix) with ESMTPS id 787BE2049A
 for <iommu@lists.linux-foundation.org>; Sun,  5 Apr 2020 08:34:03 +0000 (UTC)
IronPort-SDR: UXh/eG1kRbtC8Wn85LitieaffvY7LLOoa6Yo6n2VdvHoTMR5V4WXUdlE9kb7QGz5CuUI4EzE7A
 atKvsRRQueog==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Apr 2020 01:34:03 -0700
IronPort-SDR: De9GHe/tV7QDXgIhPjGka7nOmgTh2+xJmJaMyqNm2rpZNeZ2eiIlxBKfWQQcOv8AYnqm/5gKm0
 PJ9xiEaKp9aQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,347,1580803200"; d="scan'208";a="397179343"
Received: from allen-box.sh.intel.com ([10.239.159.139])
 by orsmga004.jf.intel.com with ESMTP; 05 Apr 2020 01:34:01 -0700
From: Lu Baolu <baolu.lu@linux.intel.com>
To: Joerg Roedel <joro@8bytes.org>
Subject: [PATCH 05/19] iommu/vt-d: Add def_domain_type callback
Date: Sun,  5 Apr 2020 16:30:39 +0800
Message-Id: <20200405083053.17865-6-baolu.lu@linux.intel.com>
...
index 6f29f5f75351..558026fe00e9 100644
...
-
 ...
 {
@@ -5227,12 +4980,6 @@ static void __dmar_remove_one_dev_info(struct device_domain_info *info)
...
@@ -5714,73 +5461,36 @@ static bool intel_iommu_capable(enum iommu_cap cap)
...
@@ -6140,6 +5850,7 @@ const struct iommu_ops intel_iommu_ops = {
