...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id 15A993AFB3
	for <lists.iommu@lfdr.de>; Mon, 10 Jun 2019 09:31:43 +0200 (CEST)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id 4A93EB5F;
	Mon, 10 Jun 2019 07:31:41 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id 709A792F
	for <iommu@lists.linux-foundation.org>;
	Mon, 10 Jun 2019 07:31:39 +0000 (UTC)
X-Greylist: whitelisted by SQLgrey-1.7.6
Received: from JPN01-OS2-obe.outbound.protection.outlook.com
	(mail-eopbgr1410121.outbound.protection.outlook.com [40.107.141.121])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id E58AE711
	for <iommu@lists.linux-foundation.org>;
	Mon, 10 Jun 2019 07:31:37 +0000 (UTC)
...
Received: from OSBPR01MB2103.jpnprd01.prod.outlook.com (52.134.242.17) by
	OSBPR01MB4741.jpnprd01.prod.outlook.com (20.179.184.76) with Microsoft
	SMTP
	Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
	15.20.1965.12; Mon, 10 Jun 2019 07:31:34 +0000
Received: from OSBPR01MB2103.jpnprd01.prod.outlook.com
	([fe80::a146:39f0:5df9:11bc]) by
	OSBPR01MB2103.jpnprd01.prod.outlook.com
	([fe80::a146:39f0:5df9:11bc%7]) with mapi id 15.20.1965.017;
	Mon, 10 Jun 2019 07:31:34 +0000
From: Biju Das <biju.das@bp.renesas.com>
To: Yoshihiro Shimoda <yoshihiro.shimoda.uh@renesas.com>, Christoph Hellwig
	<hch@lst.de>
...
x-forefront-antispam-report: SFV:NSPM;
	SFS:(10019020)(376002)(396003)(346002)(136003)(366004)(39860400002)(53754006)(189003)(199004)(6506007)(102836004)(14454004)(478600001)(64756008)(99286004)(45080400002)(76176011)(2906002)(186003)(66556008)(66476007)(73956011)(66946007)(76116006)(26005)(54906003)(74316002)(316002)(7696005)(7736002)(66446008)(966005)(110136005)(256004)(5024004)(14444005)(305945005)(66066001)(6246003)(486006)(86362001)(229853002)(3846002)(446003)(6436002)(6116002)(71190400001)(71200400001)(44832011)(11346002)(25786009)(4326008)(476003)(8676002)(68736007)(81156014)(6306002)(53936002)(52536014)(33656002)(8936002)(55016002)(81166006)(9686003)(5660300002)(6606295002);
	DIR:OUT; SFP:1102; SCL:1; SRVR:OSBPR01MB4741;
	H:OSBPR01MB2103.jpnprd01.prod.outlook.com; FPR:; SPF:None;
	LANG:en; PTR:InfoNoRecords; MX:1; A:0; 
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 10 Jun 2019 07:31:34.6439 (UTC)
