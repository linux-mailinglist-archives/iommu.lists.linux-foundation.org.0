...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id F17F4D7983
	for <lists.iommu@lfdr.de>; Tue, 15 Oct 2019 17:13:06 +0200 (CEST)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id 715DCE55;
	Tue, 15 Oct 2019 15:12:53 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id 23E80E36
	for <iommu@lists.linux-foundation.org>;
	Tue, 15 Oct 2019 15:12:08 +0000 (UTC)
X-Greylist: whitelisted by SQLgrey-1.7.6
Received: from smtp-fw-6002.amazon.com (smtp-fw-6002.amazon.com [52.95.49.90])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id 6AC71887
	for <iommu@lists.linux-foundation.org>;
	Tue, 15 Oct 2019 15:12:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
	...
	wrBBGK8K3qgpwb954jOVvACxdo3Kcq02wzh3vhhkaveOtnuyotKQi5Z0N 8=;
X-IronPort-AV: E=Sophos;i="5.67,300,1566864000"; d="scan'208";a="429292546"
Received: from iad6-co-svc-p1-lb1-vlan3.amazon.com (HELO
	email-inbound-relay-2b-859fe132.us-west-2.amazon.com)
	([10.124.125.6])
	by smtp-border-fw-out-6002.iad6.amazon.com with ESMTP;
	15 Oct 2019 15:12:05 +0000
Received: from EX13MTAUEA001.ant.amazon.com
	(pdx4-ws-svc-p6-lb7-vlan2.pdx.amazon.com [10.170.41.162])
	by email-inbound-relay-2b-859fe132.us-west-2.amazon.com (Postfix) with
	ESMTPS id D71E922186A; Tue, 15 Oct 2019 15:12:04 +0000 (UTC)
Received: from EX13D13EUA004.ant.amazon.com (10.43.165.22) by
	...
	(TLS) id 15.0.1367.3; Tue, 15 Oct 2019 15:12:04 +0000
