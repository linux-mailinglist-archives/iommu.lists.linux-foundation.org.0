...
Received: from whitealder.osuosl.org (smtp1.osuosl.org [140.211.166.138])
	by mail.lfdr.de (Postfix) with ESMTPS id EE3AF2D4415
	for <lists.iommu@lfdr.de>; Wed,  9 Dec 2020 15:24:06 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by whitealder.osuosl.org (Postfix) with ESMTP id A34618706C;
	Wed,  9 Dec 2020 14:24:05 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from whitealder.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id UVF56qYlhOqQ; Wed,  9 Dec 2020 14:24:02 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by whitealder.osuosl.org (Postfix) with ESMTP id 2958986D0C;
	Wed,  9 Dec 2020 14:24:02 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 16593C013B;
	Wed,  9 Dec 2020 14:24:02 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@lists.linuxfoundation.org
Received: from whitealder.osuosl.org (smtp1.osuosl.org [140.211.166.138])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 716FDC013B
 for <iommu@lists.linux-foundation.org>; Wed,  9 Dec 2020 14:24:00 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by whitealder.osuosl.org (Postfix) with ESMTP id 61B0C86D0C
 for <iommu@lists.linux-foundation.org>; Wed,  9 Dec 2020 14:24:00 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from whitealder.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id WCCfE2jm1DLx for <iommu@lists.linux-foundation.org>;
 Wed,  9 Dec 2020 14:23:57 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from NAM10-BN7-obe.outbound.protection.outlook.com
 (mail-bn7nam10on2077.outbound.protection.outlook.com [40.107.92.77])
 by whitealder.osuosl.org (Postfix) with ESMTPS id 0935186CE3
 for <iommu@lists.linux-foundation.org>; Wed,  9 Dec 2020 14:23:57 +0000 (UTC)
...
To: "Merger, Edgar [AUTOSOL/MAS/AUGS]" <Edgar.Merger@emerson.com>, "Huang,
 Ray" <Ray.Huang@amd.com>, "Kuehling, Felix" <Felix.Kuehling@amd.com>
...
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(4636009)(366004)(136003)(376002)(346002)(66476007)(66946007)(54906003)(6506007)(64756008)(53546011)(83380400001)(66556008)(4326008)(66446008)(26005)(4001150100001)(186003)(7696005)(76116006)(30864003)(86362001)(6636002)(966005)(9686003)(19627235002)(55016002)(508600001)(52536014)(71200400001)(33656002)(8936002)(110136005)(8676002)(5660300002)(45080400002)(2906002)(579004)(559001)(505234006);
 DIR:OUT; SFP:1101; 
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 09 Dec 2020 14:23:53.6846 (UTC)
...
> > newer sbios?  I think the attached patch should work if we can't get =

> > it fixed on the platform side.  It should only enable the quirk on =
...
> > > 0x00000000 TA RAS feature version: 0, firmware version: 0x00000000 =
...
> > > the PCI revision id of your chip (from lspci)?  Also are you just =
...
> > > > > cover this case where ATS is blacklisted. That said, it =

> > > > > affects the programming model, because we don't support the =

> > > > > unified and coherent memory model on dGPUs like we do on APUs =
