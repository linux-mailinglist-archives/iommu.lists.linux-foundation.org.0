...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id A6393328E6
	for <lists.iommu@lfdr.de>; Mon,  3 Jun 2019 08:53:43 +0200 (CEST)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id 2A338C3F;
	Mon,  3 Jun 2019 06:53:36 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id 5D596B59
	for <iommu@lists.linux-foundation.org>;
	Mon,  3 Jun 2019 06:53:34 +0000 (UTC)
X-Greylist: from auto-whitelisted by SQLgrey-1.7.6
Received: from bombadil.infradead.org (bombadil.infradead.org
	[198.137.202.133])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id B942686E
	for <iommu@lists.linux-foundation.org>;
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=UGV5V9mab2J2kyV4g/HSefYdLaD7GjMaiN7BGb1uNJE=;
	b=gAa1IT8tANyABzyuT9+Df19DPl
...
Subject: [PATCH 2/2] microblaze: use the generic uncached segment support in
	dma-direct
