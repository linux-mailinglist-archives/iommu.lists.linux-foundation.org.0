...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id B0C6CE82A1
	for <lists.iommu@lfdr.de>; Tue, 29 Oct 2019 08:42:51 +0100 (CET)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id 8667DE8D;
	Tue, 29 Oct 2019 07:42:34 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id 749DDAF3
	for <iommu@lists.linux-foundation.org>;
	Tue, 29 Oct 2019 06:41:27 +0000 (UTC)
X-Greylist: whitelisted by SQLgrey-1.7.6
Received: from mail-pf1-f174.google.com (mail-pf1-f174.google.com
	[209.85.210.174])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id B05C2FD
	for <iommu@lists.linux-foundation.org>;
	Tue, 29 Oct 2019 06:41:25 +0000 (UTC)
Received: by mail-pf1-f174.google.com with SMTP id u9so4100516pfn.4
	for <iommu@lists.linux-foundation.org>;
	Mon, 28 Oct 2019 23:41:25 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
	...
	:references;
	bh=XrWvBQ9sNdycj3useBLDFrDqzpLizWXRsjet9itNF9I=;
	b=
X-Gm-Message-State: APjAAAU3ZMAisIYZKli0TaOMzme+uXhK93GIW7q+iTpUYCnfLToFlVml
	cT6Pm7oYt+n83qXyzPPbSqjEVw==
...
Received: from localhost.localdomain ([240e:362:4dc:3a00:892e:70f7:f486:8f02])
	...
	e23sm13421834pgh.84.2019.10.28.23.41.07
