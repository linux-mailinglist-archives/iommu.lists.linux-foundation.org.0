...
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
	by mail.lfdr.de (Postfix) with ESMTPS id 2309D28627C
	for <lists.iommu@lfdr.de>; Wed,  7 Oct 2020 17:46:25 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by silver.osuosl.org (Postfix) with ESMTP id C13FF22EE7;
	Wed,  7 Oct 2020 15:46:22 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id 7a7xqGUMTigA; Wed,  7 Oct 2020 15:46:20 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by silver.osuosl.org (Postfix) with ESMTP id 1E55323018;
	Wed,  7 Oct 2020 15:46:20 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 00733C1AD6;
	Wed,  7 Oct 2020 15:46:20 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@lists.linuxfoundation.org
Received: from fraxinus.osuosl.org (smtp4.osuosl.org [140.211.166.137])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 61649C0051
 for <iommu@lists.linux-foundation.org>; Wed,  7 Oct 2020 15:46:17 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by fraxinus.osuosl.org (Postfix) with ESMTP id 46BE88638F
 for <iommu@lists.linux-foundation.org>; Wed,  7 Oct 2020 15:46:17 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from fraxinus.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id X5xe_C73p-K1 for <iommu@lists.linux-foundation.org>;
 Wed,  7 Oct 2020 15:46:16 +0000 (UTC)
X-Greylist: from auto-whitelisted by SQLgrey-1.7.6
Received: from merlin.infradead.org (merlin.infradead.org [205.233.59.134])
 by fraxinus.osuosl.org (Postfix) with ESMTPS id 90A6086360
 for <iommu@lists.linux-foundation.org>; Wed,  7 Oct 2020 15:46:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 d=infradead.org; s=merlin.20170209; h=Mime-Version:Content-Type:References:
 In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
 Content-Transfer-Encoding:Content-ID:Content-Description;
 bh=os1KmDPq27RL/3CyW0qKS2w9Sp9tT9nNyZ+r7EqlrLY=; b=q7rQ+nQiH841nC/H+2uP/YN2cr
 ;
Received: from [54.239.6.186] (helo=freeip.amazon.com)
 by merlin.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
 id 1kQBds-0006a7-QP; Wed, 07 Oct 2020 15:46:13 +0000
Message-ID: <2f09a1f97d97e638e90c6eca3ebeebb4be852f58.camel@infradead.org>
Subject: Re: [PATCH 10/13] x86/irq: Limit IOAPIC and MSI domains' affinity
 without IR
From: David Woodhouse <dwmw2@infradead.org>
To: Thomas Gleixner <tglx@linutronix.de>, x86@kernel.org
Date: Wed, 07 Oct 2020 16:46:10 +0100
In-Reply-To: <87d01u3vo6.fsf@nanos.tec.linutronix.de>
...
Content-Type: multipart/mixed; boundary="===============7446600149747294310=="
...
Content-Type: multipart/signed; micalg="sha-256";
	...
	boundary="=-pm9bSUz/gpNj8LLRbYad"


--=-pm9bSUz/gpNj8LLRbYad
...
into actual interrupts on the appropriate CPU =E2=80=94 where the APIC ID a=
nd
vector (etc.) are directly encoded in the bits of the address and the
data written. That compatibility x86 APIC MSI format is where the 8-bit=20
(or 15-bit) limit comes from.

Then interrupt remapping comes along, and now those physical address
cycles are actually handled by the IOMMU =E2=80=94 which can either handle =
the
...
then it's a price worth paying.=20
...
MDA3MTU0NjEwWjAvBgkqhkiG9w0BCQQxIgQgXbi8X10VSPJw4ss7f8qhkJ3+lgZXlNEuwf/dKqyM
DaQwgb4GCSsGAQQBgjcQBDGBsDCBrTCBlzELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIg
...

