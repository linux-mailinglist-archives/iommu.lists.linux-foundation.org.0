...
Received: from hemlock.osuosl.org (smtp2.osuosl.org [140.211.166.133])
	by mail.lfdr.de (Postfix) with ESMTPS id A4287168968
	for <lists.iommu@lfdr.de>; Fri, 21 Feb 2020 22:38:24 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by hemlock.osuosl.org (Postfix) with ESMTP id 4737F88175;
	Fri, 21 Feb 2020 21:38:23 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from hemlock.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id UZamw9kN0pEt; Fri, 21 Feb 2020 21:38:11 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by hemlock.osuosl.org (Postfix) with ESMTP id 6FD5C88171;
	Fri, 21 Feb 2020 21:38:11 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 5C6F3C013E;
	Fri, 21 Feb 2020 21:38:11 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@lists.linuxfoundation.org
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 15D64C013E
 for <iommu@lists.linux-foundation.org>; Fri, 21 Feb 2020 20:06:11 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by silver.osuosl.org (Postfix) with ESMTP id E4BF32155B
 for <iommu@lists.linux-foundation.org>; Fri, 21 Feb 2020 20:06:10 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id rTeyaAxz1HcW for <iommu@lists.linux-foundation.org>;
 Fri, 21 Feb 2020 20:05:53 +0000 (UTC)
X-Greylist: delayed 00:08:08 by SQLgrey-1.7.6
Received: from resqmta-po-03v.sys.comcast.net (resqmta-po-03v.sys.comcast.net
 [96.114.154.162])
 by silver.osuosl.org (Postfix) with ESMTPS id 80BC32010B
 for <iommu@lists.linux-foundation.org>; Fri, 21 Feb 2020 20:05:52 +0000 (UTC)
Received: from resomta-po-10v.sys.comcast.net ([96.114.154.234])
 by resqmta-po-03v.sys.comcast.net with ESMTP
 id 5CohjI0dYDv735EQhjkZ17; Fri, 21 Feb 2020 19:57:43 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=comcastmailservice.net; s=20180828_2048; t=1582315063;
 bh=ag9fgpVJMnDaV80H3cPordtAMPtImVZk6cDIozBZkcQ=;
 h=Received:Received:Received:Date:From:To:Subject:Message-ID:
 MIME-Version:Content-Type;
 b=
Received: from moe ([76.21.90.186])
 by resomta-po-10v.sys.comcast.net with ESMTPA
 id 5EQfj598mq3Ov5EQgjGwGX; Fri, 21 Feb 2020 19:57:43 +0000
X-Xfinity-VAAS: 
X-Xfinity-VMeta: sc=0.00;st=legit
Received: by moe (Postfix, from userid 1000)
 id 966E2201FF; Fri, 21 Feb 2020 11:57:41 -0800 (PST)
Date: Fri, 21 Feb 2020 11:57:41 -0800
From: Steve Morris <morris@buinea.com>
To: alsa-devel@alsa-project.org, iommu@lists.linux-foundation.org,
 linux1394-devel@lists.sourceforge.net
Subject: Re: sytem reboots when initializing Edirol FA-101 firewire audio
 interface
Message-ID: <20200221195741.GA2230@buinea.com>
References: <20200219141956.GA14216@buinea.com>
 <20200220015726.GA3578@workstation>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20200220015726.GA3578@workstation>
X-Mailman-Approved-At: Fri, 21 Feb 2020 21:38:09 +0000
...
On Thu, Feb 20, 2020 at 10:57:27AM +0900, Takashi Sakamoto wrote:
> Hi,
> 
...
Thank you for your response. I have upgraded my bios ans some alsa
packages and things have imporved somewhat.

Now, when I power on the FA-101, soetimes it works, sometimes it hangs
my system, and sometimes it reboots.

I am still seeing many AMD-Vi: Event logged [IO_PAGE_FAULT domain=0x0001
address=0xdb3e8000 flags=0x0000] messages




Several alsa packages updated this morning.
alsa-topology-conf (1.2.1-1 -> 1.2.2-1)
alsa-ucm-conf (1.2.1.2-1 -> 1.2.2-1)
alsa-lib (1.2.1.2-3 -> 1.2.2-1)
alsa-plugins (1.2.1-5 -> 1.2.2-1)
alsa-utils (1.2.1-2 -> 1.2.2-1)
...
XT / 5700/5700 XT] (rev c1) video card.

I just upgraded my BIOS from X570GX.F4 2019/09/04 AGES 1.0.0.3ABB to X570GX.F11 2019/12/09 AGES 1.0.0.4B

Here is my kernel config (stock Arch config)
