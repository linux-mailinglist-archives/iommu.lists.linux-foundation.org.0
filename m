...
Received: from smtp2.osuosl.org (smtp2.osuosl.org [140.211.166.133])
	by mail.lfdr.de (Postfix) with ESMTPS id 56C243EBAC7
	for <lists.iommu@lfdr.de>; Fri, 13 Aug 2021 19:01:08 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by smtp2.osuosl.org (Postfix) with ESMTP id 0669F40284;
	Fri, 13 Aug 2021 17:01:07 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp2.osuosl.org ([127.0.0.1])
	by localhost (smtp2.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id iVSzscCmbhSH; Fri, 13 Aug 2021 17:01:03 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by smtp2.osuosl.org (Postfix) with ESMTPS id 425B2402D9;
	Fri, 13 Aug 2021 17:01:03 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 29E7CC001F;
	Fri, 13 Aug 2021 17:01:03 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@lists.linuxfoundation.org
Received: from smtp3.osuosl.org (smtp3.osuosl.org [140.211.166.136])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 10636C000E
 for <iommu@lists.linux-foundation.org>; Fri, 13 Aug 2021 17:01:02 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp3.osuosl.org (Postfix) with ESMTP id E694560608
 for <iommu@lists.linux-foundation.org>; Fri, 13 Aug 2021 17:01:01 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Authentication-Results: smtp3.osuosl.org (amavisd-new);
 dkim=pass (1024-bit key) header.d=amd.com
Received: from smtp3.osuosl.org ([127.0.0.1])
 by localhost (smtp3.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id x98qjoP409Mj for <iommu@lists.linux-foundation.org>;
 Fri, 13 Aug 2021 17:01:00 +0000 (UTC)
X-Greylist: whitelisted by SQLgrey-1.8.0
Received: from NAM12-BN8-obe.outbound.protection.outlook.com
 (mail-bn8nam12on2087.outbound.protection.outlook.com [40.107.237.87])
 by smtp3.osuosl.org (Postfix) with ESMTPS id 728B7605E2
 for <iommu@lists.linux-foundation.org>; Fri, 13 Aug 2021 17:01:00 +0000 (UTC)
...
Subject: [PATCH v2 08/12] treewide: Replace the use of mem_encrypt_active()
 with prot_guest_has()
...
Received: from tlendack-t1.amd.com (165.204.77.1) by
 ...
 15.20.4436.9 via Frontend Transport; Fri, 13 Aug 2021 17:00:55 +0000
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(4636009)(346002)(366004)(39860400002)(136003)(376002)(396003)(30864003)(186003)(956004)(83380400001)(2616005)(86362001)(921005)(2906002)(66476007)(5660300002)(7696005)(6486002)(478600001)(8676002)(8936002)(66946007)(7416002)(4326008)(52116002)(66556008)(7406005)(54906003)(316002)(38350700002)(36756003)(6666004)(26005)(38100700002);
 DIR:OUT; SFP:1101; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 13 Aug 2021 17:00:56.7240 (UTC)
