...
Received: from smtp2.osuosl.org (smtp2.osuosl.org [140.211.166.133])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FCC350C057
	for <lists.iommu@lfdr.de>; Fri, 22 Apr 2022 21:26:15 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by smtp2.osuosl.org (Postfix) with ESMTP id 0FC7E40AEB;
	Fri, 22 Apr 2022 19:26:14 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp2.osuosl.org ([127.0.0.1])
	by localhost (smtp2.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id oYLRYxk6Epnu; Fri, 22 Apr 2022 19:26:12 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [IPv6:2605:bc80:3010:104::8cd3:938])
	by smtp2.osuosl.org (Postfix) with ESMTPS id 85E5940AE9;
	Fri, 22 Apr 2022 19:26:12 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 4BFDCC002D;
	Fri, 22 Apr 2022 19:26:12 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@lists.linuxfoundation.org
Received: from smtp3.osuosl.org (smtp3.osuosl.org [IPv6:2605:bc80:3010::136])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 080CEC002D
 for <iommu@lists.linux-foundation.org>; Fri, 22 Apr 2022 19:26:11 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp3.osuosl.org (Postfix) with ESMTP id E19166106C
 for <iommu@lists.linux-foundation.org>; Fri, 22 Apr 2022 19:26:10 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Authentication-Results: smtp3.osuosl.org (amavisd-new);
 dkim=pass (1024-bit key) header.d=amd.com
Received: from smtp3.osuosl.org ([127.0.0.1])
 by localhost (smtp3.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id de5hZbAliCKb for <iommu@lists.linux-foundation.org>;
 Fri, 22 Apr 2022 19:26:08 +0000 (UTC)
X-Greylist: whitelisted by SQLgrey-1.8.0
Received: from NAM12-BN8-obe.outbound.protection.outlook.com
 (mail-bn8nam12on2062f.outbound.protection.outlook.com
 [IPv6:2a01:111:f400:fe5b::62f])
 by smtp3.osuosl.org (Postfix) with ESMTPS id 4045A61071
 for <iommu@lists.linux-foundation.org>; Fri, 22 Apr 2022 19:26:08 +0000 (UTC)
...
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230001)(4636009)(366004)(7416002)(2906002)(52536014)(8936002)(316002)(122000001)(76116006)(38100700002)(33656002)(53546011)(966005)(7696005)(9686003)(110136005)(30864003)(6506007)(5660300002)(6636002)(64756008)(921005)(508600001)(71200400001)(86362001)(66446008)(66476007)(38070700005)(55016003)(186003)(66556008)(8676002)(66946007)(83380400001)(26005);
 DIR:OUT; SFP:1101; 
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 22 Apr 2022 19:26:04.3261 (UTC)
...
One of my coworkers mentioned that it might be cleaner to call these out as ACPI related.  Will resend a new patch with that clarified.
...
> +adding option iommu=pt to the kernel command line use a 1:1 mapping for
> +the IOMMU.  If this fixes anything, please ensure you file a bug reporting the
> problem.
> +
> +Fault reporting
> +---------------
