...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id F1A968F588
	for <lists.iommu@lfdr.de>; Thu, 15 Aug 2019 22:11:51 +0200 (CEST)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id 9EE0D12B3;
	Thu, 15 Aug 2019 20:09:53 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id ED1481237
	for <iommu@lists.linux-foundation.org>;
	Thu, 15 Aug 2019 20:09:49 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id 3BA3D8A6
	for <iommu@lists.linux-foundation.org>;
	Thu, 15 Aug 2019 20:09:49 +0000 (UTC)
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,389,1559545200"; d="scan'208";a="188596256"
...
Subject: [PATCH v5 19/19] iommu/vt-d: Add svm/sva invalidate function
Date: Thu, 15 Aug 2019 13:13:25 -0700
Message-Id: <1565900005-62508-20-git-send-email-jacob.jun.pan@linux.intel.com>
...
@@ -5169,6 +5169,175 @@ static void intel_iommu_aux_detach_device(struct iommu_domain *domain,
...
@@ -5692,6 +5861,7 @@ const struct iommu_ops intel_iommu_ops = {
