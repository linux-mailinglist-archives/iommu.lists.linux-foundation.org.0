...
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
	by mail.lfdr.de (Postfix) with ESMTPS id DC484286F3D
	for <lists.iommu@lfdr.de>; Thu,  8 Oct 2020 09:21:30 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by silver.osuosl.org (Postfix) with ESMTP id 8555D20367;
	Thu,  8 Oct 2020 07:21:28 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id RB1UwdfXPo4x; Thu,  8 Oct 2020 07:21:26 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by silver.osuosl.org (Postfix) with ESMTP id EC71A20113;
	Thu,  8 Oct 2020 07:21:25 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id CDEAEC016F;
	Thu,  8 Oct 2020 07:21:25 +0000 (UTC)
X-Original-To: iommu@lists.linux-foundation.org
Delivered-To: iommu@lists.linuxfoundation.org
Received: from hemlock.osuosl.org (smtp2.osuosl.org [140.211.166.133])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 71331C016F
 for <iommu@lists.linux-foundation.org>; Thu,  8 Oct 2020 07:21:24 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by hemlock.osuosl.org (Postfix) with ESMTP id 581C7873A5
 for <iommu@lists.linux-foundation.org>; Thu,  8 Oct 2020 07:21:24 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from hemlock.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id fU+0L+kE71m0 for <iommu@lists.linux-foundation.org>;
 Thu,  8 Oct 2020 07:21:23 +0000 (UTC)
X-Greylist: from auto-whitelisted by SQLgrey-1.7.6
Received: from merlin.infradead.org (merlin.infradead.org [205.233.59.134])
 by hemlock.osuosl.org (Postfix) with ESMTPS id 6C26087364
 for <iommu@lists.linux-foundation.org>; Thu,  8 Oct 2020 07:21:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 d=infradead.org; s=merlin.20170209; h=Mime-Version:Content-Type:References:
 In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
 Content-Transfer-Encoding:Content-ID:Content-Description;
 bh=KLFb78+cZx0ED5mTRRjwMBelmmcyni9ath5VJlsGwes=; b=yO/1BtDqfylDkzl3cWOFtBiieB
 ;
Received: from [54.239.6.185] (helo=freeip.amazon.com)
 by merlin.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
 id 1kQQEp-0005UF-I5; Thu, 08 Oct 2020 07:21:19 +0000
Message-ID: <119c2f993cac5d57c54d4720addc9f32bf1daadd.camel@infradead.org>
Subject: Re: [PATCH 07/13] irqdomain: Add max_affinity argument to
 irq_domain_alloc_descs()
From: David Woodhouse <dwmw2@infradead.org>
To: Thomas Gleixner <tglx@linutronix.de>, x86@kernel.org
Date: Thu, 08 Oct 2020 08:21:17 +0100
...
Content-Type: multipart/mixed; boundary="===============2437272522388384950=="
...
Content-Type: multipart/signed; micalg="sha-256";
	...
	boundary="=-jrFxRnOtbWpvf4jRQKUL"


--=-jrFxRnOtbWpvf4jRQKUL
...
That's because =E2=80=94 at least on x86 =E2=80=94 we don't assign CPU numb=
ers to CPUs
...
to refrain from bringing up the corresponding queue.=20
...
MDA4MDcyMTE3WjAvBgkqhkiG9w0BCQQxIgQg9KMQ7JfTMpA/grpdP5D7IADHmLTUTUXh04CkGRrv
9KEwgb4GCSsGAQQBgjcQBDGBsDCBrTCBlzELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIg
...

